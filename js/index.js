window.onload = function () {
    ...
    progressBtn.onmousedown=function(ev)
    {
         var oEvent=ev||event;        
         var disX=0;
         disX=oEvent.clientX-progressBtn.offsetLeft;
         progressBtn.onmousemove=function(ev){
             var oEvent=ev||event;
             ...
             else if(i>progressBar.offsetWidth-progressBtn.offsetWidth)
             {
                i=progressBar.offsetWidth-progressBtn.offsetWidth;
             }
             progressBtn.style.left=i+'px';
             
         }; 
         progressBtn.onmouseup=function()
         {
            progressBtn.onkeyup=null;
            progressBtn.onmousemove=null;
         };
         return false;
